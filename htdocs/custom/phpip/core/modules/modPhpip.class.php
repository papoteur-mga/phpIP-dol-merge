...
/**
 * 	\defgroup	phpip	Ip module
 * 	\brief		Ip module descriptor.
 * 	\file		core/modules/modIp.class.php
 * 	\ingroup	phpip
 * 	\brief		Description and activation file for module Ip
 */
include_once DOL_DOCUMENT_ROOT . "/core/modules/DolibarrModules.class.php";

/**
 * Description and activation class for module Ip
 */
class modPhpip extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		// (where XXX is value of numeric property 'numero' of module)
		$this->description = "Description of module Ip";
		// Possible values for version are: 'development', 'experimental' or version
		$this->version = 'development';
		// Key used in llx_const table to save module status enabled/disabled
		// (where phpip is value of property name of module in uppercase)
		...
		$this->picto = 'phpip@phpip'; // mypicto@phpip
		// Defined all module parts (triggers, login, substitutions, menus, css, etc...)
		// for default path (eg: /phpip/core/xxxxx) (0=disable, 1=enable)
		// for specific path of parts (eg: /phpip/core/modules/barcode)
		// for specific css file (eg: /phpip/css/phpip.css.php)
		$this->module_parts = array(
			...
			'css' => array('phpip/css/mycss.css.php'),
			// Set this to relative path of js file if module must load a js on all pages
			// 'js' => array('phpip/js/phpip.js'),
		...
		// Example: this->dirs = array("/phpip/temp");
		$this->dirs = array();

		// Config pages. Put here list of php pages
		// stored into phpip/admin directory, used to setup module.
		$this->config_page_url = array("admin_phpip.php@phpip");
		...
		// Language files list (langfiles@phpip)
		$this->langfiles = array("phpip@phpip");
		// Constants
		...
		// Example:
		$this->tabs = array('thirdparty:+phpip:phpIP:phpip:1:/custom/phpip/doc/doc.php?socid=__ID__'
			//	// To add a new tab identified by code tabname1
			//	'objecttype:+tabname1:Title1:langfile@phpip:$user->rights->phpip->read:/phpip/mynewtab1.php?id=__ID__',
			//	// To add another new tab identified by code tabname2
			//	'objecttype:+tabname2:Title2:langfile@phpip:$user->rights->othermodule->read:/phpip/mynewtab2.php?id=__ID__',
			//	// To remove an existing tab identified by code tabname
			//	'objecttype:-tabname'
		);

		// Dictionaries
		if (! isset($conf->phpip->enabled)) {
			$conf->phpip=new stdClass();
			$conf->phpip->enabled = 0;
		}
		$this->dictionaries = array();
		/* Example:
		  // This is to avoid warnings
		  if (! isset($conf->phpip->enabled)) $conf->phpip->enabled=0;
		  $this->dictionaries=array(
			  'langs'=>'phpip@phpip',
		...
		//	'leftmenu'=>'phpip',
		//	'url'=>'/phpip/pagetop.php',
		//	// Lang file to use (without .lang) by module.
		//	// File must be in langs/code_CODE/ directory.
		//	'langs'=>'mylangfile',
		//	'position'=>100,
		//	// Define condition to show or hide menu entry.
		//	// Use '$conf->phpip->enabled' if entry must be visible if module is enabled.
		//	'enabled'=>'$conf->phpip->enabled',
		//	// Use 'perms'=>'$user->rights->phpip->level1->level2'
